...
insert into user(id,firstname,lastname,character_name, character_strength, character_level,character_exp,character_gold,password,story_chapter) values
    (1,'Alex','Apple','Attila',3,1,12,3,'unknackbar',1),
